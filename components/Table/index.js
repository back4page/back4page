    ...
    <div className="flex flex-col items-stretch">
      ...
      <div className="flex flex-col items-stretch overflow-x-scroll lg:overflow-x-hidden ">
        <table {...getTableProps()} className="table-auto text-xs lg:text-base">
          <thead className="bg-custom-gray8">
              ...
              <tr key={i} {...headerGroup.getHeaderGroupProps()}>
                {headerGroup.headers.map((column, i) => (
                  <th
                    ...
                    className="px-4 py-3 text-sm border-collapse border border-gray-600 capitalize"
                  >
                  ...
                  {row.cells.map((cell, i) => {
                    return (
                      <td
                        ...
                        className="px-4 py-3  text-sm text-white font-semibold border-collapse border border-gray-600"
                      >
                        {cell.render("Cell")}
                      </td>
                    );
